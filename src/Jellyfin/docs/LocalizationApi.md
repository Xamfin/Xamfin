# Jellyfin.Api.Api.LocalizationApi
...
namespace Example
{
    public class GetCountriesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LocalizationApi(Configuration.Default);
            ...
            {
                Debug.Print("Exception when calling LocalizationApi.GetCountries: " + e.Message );
...
namespace Example
{
    public class GetCulturesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling LocalizationApi.GetCultures: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetLocalizationOptionsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "http://localhost";
            ...
            {
                Debug.Print("Exception when calling LocalizationApi.GetLocalizationOptions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetParentalRatingsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "http://localhost";
            ...
            {
                Debug.Print("Exception when calling LocalizationApi.GetParentalRatings: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
