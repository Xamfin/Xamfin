...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AlbumInfoRemoteSearchQuery :  IEquatable<AlbumInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlbumInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public AlbumInfoRemoteSearchQuery(AlbumInfo searchInfo = default(AlbumInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as AlbumInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if AlbumInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of AlbumInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlbumInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
