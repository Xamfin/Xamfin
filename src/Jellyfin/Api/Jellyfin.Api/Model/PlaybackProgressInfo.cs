...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlaybackProgressInfo :  IEquatable<PlaybackProgressInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public PlaybackProgressInfo(bool canSeek = default(bool), BaseItemDto item = default(BaseItemDto), Guid itemId = default(Guid), string sessionId = default(string), string mediaSourceId = default(string), int? audioStreamIndex = default(int?), int? subtitleStreamIndex = default(int?), bool isPaused = default(bool), bool isMuted = default(bool), long? positionTicks = default(long?), long? playbackStartTimeTicks = default(long?), int? volumeLevel = default(int?), int? brightness = default(int?), string aspectRatio = default(string), PlayMethod? playMethod = default(PlayMethod?), string liveStreamId = default(string), string playSessionId = default(string), RepeatMode? repeatMode = default(RepeatMode?), List<QueueItem> nowPlayingQueue = default(List<QueueItem>), string playlistItemId = default(string))
        {
            this.Item = item;
