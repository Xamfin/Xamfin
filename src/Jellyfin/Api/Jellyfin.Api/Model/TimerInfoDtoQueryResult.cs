...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimerInfoDtoQueryResult :  IEquatable<TimerInfoDtoQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimerInfoDtoQueryResult" /> class.
        /// </summary>
        ...
        public TimerInfoDtoQueryResult(List<TimerInfoDto> items = default(List<TimerInfoDto>), int totalRecordCount = default(int), int startIndex = default(int))
        {
            this.Items = items;
            this.Items = items;
        ...
        public List<TimerInfoDto> Items { get; set; }
        ...
        {
            return this.Equals(input as TimerInfoDtoQueryResult);
        }

        /// <summary>
        /// Returns true if TimerInfoDtoQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TimerInfoDtoQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimerInfoDtoQueryResult input)
        {
            if (input == null)
                return false;
