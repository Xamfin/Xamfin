...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteSubtitleInfo :  IEquatable<RemoteSubtitleInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public RemoteSubtitleInfo(string threeLetterISOLanguageName = default(string), string id = default(string), string providerName = default(string), string name = default(string), string format = default(string), string author = default(string), string comment = default(string), DateTime? dateCreated = default(DateTime?), float? communityRating = default(float?), int? downloadCount = default(int?), bool? isHashMatch = default(bool?))
        {
