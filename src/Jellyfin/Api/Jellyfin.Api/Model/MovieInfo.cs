...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MovieInfo :  IEquatable<MovieInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public MovieInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool))
        {
            this.Name = name;
            this.Path = path;
        ...
        {
            return this.Equals(input as MovieInfo);
        }

        /// <summary>
        /// Returns true if MovieInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MovieInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MovieInfo input)
        {
            if (input == null)
                return false;
