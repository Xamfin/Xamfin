...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MovieInfoRemoteSearchQuery :  IEquatable<MovieInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MovieInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public MovieInfoRemoteSearchQuery(MovieInfo searchInfo = default(MovieInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as MovieInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if MovieInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of MovieInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MovieInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
