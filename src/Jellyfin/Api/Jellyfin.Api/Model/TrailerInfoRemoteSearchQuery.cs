...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailerInfoRemoteSearchQuery :  IEquatable<TrailerInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrailerInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public TrailerInfoRemoteSearchQuery(TrailerInfo searchInfo = default(TrailerInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as TrailerInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if TrailerInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailerInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailerInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
