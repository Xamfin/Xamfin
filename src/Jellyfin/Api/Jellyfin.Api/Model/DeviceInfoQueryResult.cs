...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceInfoQueryResult :  IEquatable<DeviceInfoQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInfoQueryResult" /> class.
        /// </summary>
        ...
        public DeviceInfoQueryResult(List<DeviceInfo> items = default(List<DeviceInfo>), int totalRecordCount = default(int), int startIndex = default(int))
        {
            this.Items = items;
            this.Items = items;
        ...
        {
            return this.Equals(input as DeviceInfoQueryResult);
        }

        /// <summary>
        /// Returns true if DeviceInfoQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceInfoQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceInfoQueryResult input)
        {
            if (input == null)
                return false;
