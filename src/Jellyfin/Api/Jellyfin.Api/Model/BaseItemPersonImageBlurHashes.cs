...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseItemPersonImageBlurHashes :  IEquatable<BaseItemPersonImageBlurHashes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseItemPersonImageBlurHashes" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BaseItemPersonImageBlurHashes);
        }

        /// <summary>
        /// Returns true if BaseItemPersonImageBlurHashes instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseItemPersonImageBlurHashes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseItemPersonImageBlurHashes input)
        {
            if (input == null)
                return false;
