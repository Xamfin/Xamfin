...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArtistInfo :  IEquatable<ArtistInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public ArtistInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool), List<SongInfo> songInfos = default(List<SongInfo>))
        {
            this.Name = name;
            this.Path = path;
        ...
        {
            return this.Equals(input as ArtistInfo);
        }

        /// <summary>
        /// Returns true if ArtistInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtistInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtistInfo input)
        {
            if (input == null)
                return false;
