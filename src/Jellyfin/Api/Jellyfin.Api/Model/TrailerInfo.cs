...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrailerInfo :  IEquatable<TrailerInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public TrailerInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool))
        {
            this.Name = name;
            this.Path = path;
        ...
        {
            return this.Equals(input as TrailerInfo);
        }

        /// <summary>
        /// Returns true if TrailerInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailerInfo input)
        {
            if (input == null)
                return false;
