...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MusicVideoInfo :  IEquatable<MusicVideoInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MusicVideoInfo" /> class.
        /// </summary>
        ...
        public MusicVideoInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool), List<string> artists = default(List<string>))
        {
            this.Name = name;
            this.Path = path;
        ...
        {
            return this.Equals(input as MusicVideoInfo);
        }

        /// <summary>
        /// Returns true if MusicVideoInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MusicVideoInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MusicVideoInfo input)
        {
            if (input == null)
                return false;
