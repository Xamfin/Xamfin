...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthenticationInfoQueryResult :  IEquatable<AuthenticationInfoQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationInfoQueryResult" /> class.
        /// </summary>
        ...
        public AuthenticationInfoQueryResult(List<AuthenticationInfo> items = default(List<AuthenticationInfo>), int totalRecordCount = default(int), int startIndex = default(int))
        {
            this.Items = items;
            this.Items = items;
        ...
        {
            return this.Equals(input as AuthenticationInfoQueryResult);
        }

        /// <summary>
        /// Returns true if AuthenticationInfoQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticationInfoQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticationInfoQueryResult input)
        {
            if (input == null)
                return false;
