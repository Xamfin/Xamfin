...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MusicVideoInfoRemoteSearchQuery :  IEquatable<MusicVideoInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MusicVideoInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public MusicVideoInfoRemoteSearchQuery(MusicVideoInfo searchInfo = default(MusicVideoInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as MusicVideoInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if MusicVideoInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of MusicVideoInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MusicVideoInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
