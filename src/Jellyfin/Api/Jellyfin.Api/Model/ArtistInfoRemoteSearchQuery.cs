...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArtistInfoRemoteSearchQuery :  IEquatable<ArtistInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtistInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public ArtistInfoRemoteSearchQuery(ArtistInfo searchInfo = default(ArtistInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as ArtistInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if ArtistInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtistInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtistInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
