...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TranscodingProfile :  IEquatable<TranscodingProfile>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <param name="enableSubtitlesInManifest">enableSubtitlesInManifest.</param>
        ...
        public TranscodingProfile(string container = default(string), DlnaProfileType? type = default(DlnaProfileType?), string videoCodec = default(string), string audioCodec = default(string), string protocol = default(string), bool estimateContentLength = default(bool), bool enableMpegtsM2TsMode = default(bool), TranscodeSeekInfo? transcodeSeekInfo = default(TranscodeSeekInfo?), bool copyTimestamps = default(bool), EncodingContext? context = default(EncodingContext?), bool enableSubtitlesInManifest = default(bool), string maxAudioChannels = default(string), int minSegments = default(int), int segmentLength = default(int), bool breakOnNonKeyFrames = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name="EnableSubtitlesInManifest", EmitDefaultValue=false)]
        ...
        public bool Equals(TranscodingProfile input)
        {
            ...
            return 
                ...
                (
                    this.EnableSubtitlesInManifest == input.EnableSubtitlesInManifest ||
                    (this.EnableSubtitlesInManifest != null &&
                    this.EnableSubtitlesInManifest.Equals(input.EnableSubtitlesInManifest))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableSubtitlesInManifest != null)
                    hashCode = hashCode * 59 + this.EnableSubtitlesInManifest.GetHashCode();
