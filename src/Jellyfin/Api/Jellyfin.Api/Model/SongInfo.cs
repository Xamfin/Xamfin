...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SongInfo :  IEquatable<SongInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public SongInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool), List<string> albumArtists = default(List<string>), string album = default(string), List<string> artists = default(List<string>))
        {
            this.Name = name;
            this.Path = path;
