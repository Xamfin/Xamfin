...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BoxSetInfoRemoteSearchQuery :  IEquatable<BoxSetInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxSetInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public BoxSetInfoRemoteSearchQuery(BoxSetInfo searchInfo = default(BoxSetInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as BoxSetInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if BoxSetInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of BoxSetInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoxSetInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
