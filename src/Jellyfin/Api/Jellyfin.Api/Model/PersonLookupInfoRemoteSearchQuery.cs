...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonLookupInfoRemoteSearchQuery :  IEquatable<PersonLookupInfoRemoteSearchQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonLookupInfoRemoteSearchQuery" /> class.
        /// </summary>
        ...
        public PersonLookupInfoRemoteSearchQuery(PersonLookupInfo searchInfo = default(PersonLookupInfo), Guid itemId = default(Guid), string searchProviderName = default(string), bool includeDisabledProviders = default(bool))
        {
        ...
        {
            return this.Equals(input as PersonLookupInfoRemoteSearchQuery);
        }

        /// <summary>
        /// Returns true if PersonLookupInfoRemoteSearchQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonLookupInfoRemoteSearchQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonLookupInfoRemoteSearchQuery input)
        {
            if (input == null)
                return false;
