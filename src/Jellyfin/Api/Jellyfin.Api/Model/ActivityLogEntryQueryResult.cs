...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActivityLogEntryQueryResult :  IEquatable<ActivityLogEntryQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityLogEntryQueryResult" /> class.
        /// </summary>
        ...
        public ActivityLogEntryQueryResult(List<ActivityLogEntry> items = default(List<ActivityLogEntry>), int totalRecordCount = default(int), int startIndex = default(int))
        {
            this.Items = items;
            this.Items = items;
        ...
        {
            return this.Equals(input as ActivityLogEntryQueryResult);
        }

        /// <summary>
        /// Returns true if ActivityLogEntryQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivityLogEntryQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityLogEntryQueryResult input)
        {
            if (input == null)
                return false;
