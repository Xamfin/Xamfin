...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PreviousItemRequestDto :  IEquatable<PreviousItemRequestDto>, IValidatableObject
    {
        /// <summary>
        ...
        public PreviousItemRequestDto(Guid playlistItemId = default(Guid))
        {
        ...
        {
            return this.Equals(input as PreviousItemRequestDto);
        }

        /// <summary>
        /// Returns true if PreviousItemRequestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PreviousItemRequestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviousItemRequestDto input)
        {
            if (input == null)
                return false;
