...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SeriesTimerInfoDtoQueryResult :  IEquatable<SeriesTimerInfoDtoQueryResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesTimerInfoDtoQueryResult" /> class.
        /// </summary>
        ...
        public SeriesTimerInfoDtoQueryResult(List<SeriesTimerInfoDto> items = default(List<SeriesTimerInfoDto>), int totalRecordCount = default(int), int startIndex = default(int))
        {
            this.Items = items;
            this.Items = items;
        ...
        public List<SeriesTimerInfoDto> Items { get; set; }
        ...
        {
            return this.Equals(input as SeriesTimerInfoDtoQueryResult);
        }

        /// <summary>
        /// Returns true if SeriesTimerInfoDtoQueryResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SeriesTimerInfoDtoQueryResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeriesTimerInfoDtoQueryResult input)
        {
            if (input == null)
                return false;
