...
namespace Jellyfin.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonLookupInfo :  IEquatable<PersonLookupInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonLookupInfo" /> class.
        /// </summary>
        ...
        public PersonLookupInfo(string name = default(string), string path = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), Dictionary<string, string> providerIds = default(Dictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTime? premiereDate = default(DateTime?), bool isAutomated = default(bool))
        {
            this.Name = name;
            this.Path = path;
        ...
        {
            return this.Equals(input as PersonLookupInfo);
        }

        /// <summary>
        /// Returns true if PersonLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonLookupInfo input)
        {
            if (input == null)
                return false;
