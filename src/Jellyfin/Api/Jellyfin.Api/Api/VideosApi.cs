...
namespace Jellyfin.Api.Api
{
    ...
    public interface IVideosApi : IApiAccessor
    {
        ...
        ApiResponse<Object> DeleteAlternateSourcesWithHttpInfo (Guid itemId);
        /// <summary>
        ...
        BaseItemDtoQueryResult GetAdditionalPart (Guid itemId, Guid? userId = default(Guid?));
        ...
        ApiResponse<BaseItemDtoQueryResult> GetAdditionalPartWithHttpInfo (Guid itemId, Guid? userId = default(Guid?));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Jellyfin.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="itemId">The item id.</param>
        /// <param name="container">The video container. Possible values are: ts, webm, asf, wmv, ogv, mp4, m4v, mkv, mpeg, mpg, avi, 3gp, wmv, wtv, m2ts, mov, iso, flv. (optional)</param>
        ...
        ApiResponse<System.IO.Stream> GetVideoStreamWithHttpInfo (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        System.IO.Stream GetVideoStreamByContainer (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        ApiResponse<System.IO.Stream> GetVideoStreamByContainerWithHttpInfo (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        System.IO.Stream HeadVideoStream (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        ApiResponse<System.IO.Stream> HeadVideoStreamWithHttpInfo (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        System.IO.Stream HeadVideoStreamByContainer (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        ApiResponse<System.IO.Stream> HeadVideoStreamByContainerWithHttpInfo (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>));
        /// <summary>
        ...
        /// <param name="ids">Item id list. This allows multiple, comma delimited.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> MergeVersionsWithHttpInfo (List<Guid> ids);
        ...
        System.Threading.Tasks.Task DeleteAlternateSourcesAsync (Guid itemId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteAlternateSourcesWithHttpInfoAsync (Guid itemId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets additional parts for a video.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<BaseItemDtoQueryResult> GetAdditionalPartAsync (Guid itemId, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BaseItemDtoQueryResult>> GetAdditionalPartWithHttpInfoAsync (Guid itemId, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetVideoStreamWithHttpInfoAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        System.Threading.Tasks.Task<System.IO.Stream> GetVideoStreamByContainerAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetVideoStreamByContainerWithHttpInfoAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        System.Threading.Tasks.Task<System.IO.Stream> HeadVideoStreamAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> HeadVideoStreamWithHttpInfoAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a video stream.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        System.Threading.Tasks.Task<System.IO.Stream> HeadVideoStreamByContainerAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> HeadVideoStreamByContainerWithHttpInfoAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Merges videos into a single record.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task MergeVersionsAsync (List<Guid> ids, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> MergeVersionsWithHttpInfoAsync (List<Guid> ids, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class VideosApi : IVideosApi
    {
        ...
        /// <returns></returns>
        public VideosApi(Jellyfin.Api.Client.Configuration configuration = null)
        {
        ...
        /// <param name="itemId">The item id.</param>
        /// <returns></returns>
        public void DeleteAlternateSources (Guid itemId)
        {
        ...
        /// <param name="itemId">The item id.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteAlternateSourcesWithHttpInfo (Guid itemId)
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->DeleteAlternateSources");

            var localVarPath = "/Videos/{itemId}/AlternateSources";
            ...
            {
                Exception exception = ExceptionFactory("DeleteAlternateSources", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteAlternateSourcesAsync (Guid itemId, CancellationToken cancellationToken = default(CancellationToken))
        {
             await DeleteAlternateSourcesWithHttpInfoAsync(itemId, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteAlternateSourcesWithHttpInfoAsync (Guid itemId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->DeleteAlternateSources");
        ...
        /// <param name="userId">Optional. Filter by user id, and attach user data. (optional)</param>
        /// <returns>BaseItemDtoQueryResult</returns>
        public BaseItemDtoQueryResult GetAdditionalPart (Guid itemId, Guid? userId = default(Guid?))
        {
        ...
        /// <param name="userId">Optional. Filter by user id, and attach user data. (optional)</param>
        /// <returns>ApiResponse of BaseItemDtoQueryResult</returns>
        public ApiResponse<BaseItemDtoQueryResult> GetAdditionalPartWithHttpInfo (Guid itemId, Guid? userId = default(Guid?))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetAdditionalPart");

            var localVarPath = "/Videos/{itemId}/AdditionalParts";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAdditionalPart", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of BaseItemDtoQueryResult</returns>
        public async System.Threading.Tasks.Task<BaseItemDtoQueryResult> GetAdditionalPartAsync (Guid itemId, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<BaseItemDtoQueryResult> localVarResponse = await GetAdditionalPartWithHttpInfoAsync(itemId, userId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (BaseItemDtoQueryResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<BaseItemDtoQueryResult>> GetAdditionalPartWithHttpInfoAsync (Guid itemId, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetAdditionalPart");
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> GetVideoStreamWithHttpInfo (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetVideoStream");

            var localVarPath = "/Videos/{itemId}/stream";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetVideoStream", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetVideoStreamAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await GetVideoStreamWithHttpInfoAsync(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetVideoStreamWithHttpInfoAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetVideoStream");
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream GetVideoStreamByContainer (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
             ApiResponse<System.IO.Stream> localVarResponse = GetVideoStreamByContainerWithHttpInfo(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> GetVideoStreamByContainerWithHttpInfo (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetVideoStreamByContainer");
            // verify the required parameter 'container' is set
            if (container == null)
                throw new ApiException(400, "Missing required parameter 'container' when calling VideosApi->GetVideoStreamByContainer");

            var localVarPath = "/Videos/{itemId}/stream.{container}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetVideoStreamByContainer", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetVideoStreamByContainerAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await GetVideoStreamByContainerWithHttpInfoAsync(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetVideoStreamByContainerWithHttpInfoAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->GetVideoStreamByContainer");
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream HeadVideoStream (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
             ApiResponse<System.IO.Stream> localVarResponse = HeadVideoStreamWithHttpInfo(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> HeadVideoStreamWithHttpInfo (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->HeadVideoStream");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("HeadVideoStream", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> HeadVideoStreamAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await HeadVideoStreamWithHttpInfoAsync(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> HeadVideoStreamWithHttpInfoAsync (Guid itemId, string container = default(string), bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->HeadVideoStream");
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream HeadVideoStreamByContainer (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
             ApiResponse<System.IO.Stream> localVarResponse = HeadVideoStreamByContainerWithHttpInfo(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions);
             return localVarResponse.Data;
        }
        ...
        /// <param name="streamOptions">Optional. The streaming options. (optional)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> HeadVideoStreamByContainerWithHttpInfo (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->HeadVideoStreamByContainer");
            // verify the required parameter 'container' is set
            if (container == null)
                throw new ApiException(400, "Missing required parameter 'container' when calling VideosApi->HeadVideoStreamByContainer");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("HeadVideoStreamByContainer", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> HeadVideoStreamByContainerAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await HeadVideoStreamByContainerWithHttpInfoAsync(itemId, container, _static, _params, tag, deviceProfileId, playSessionId, segmentContainer, segmentLength, minSegments, mediaSourceId, deviceId, audioCodec, enableAutoStreamCopy, allowVideoStreamCopy, allowAudioStreamCopy, breakOnNonKeyFrames, audioSampleRate, maxAudioBitDepth, audioBitRate, audioChannels, maxAudioChannels, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, requireAvc, deInterlace, requireNonAnamorphic, transcodingMaxAudioChannels, cpuCoreLimit, liveStreamId, enableMpegtsM2TsMode, videoCodec, subtitleCodec, transcodeReasons, audioStreamIndex, videoStreamIndex, context, streamOptions, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> HeadVideoStreamByContainerWithHttpInfoAsync (Guid itemId, string container, bool? _static = default(bool?), string _params = default(string), string tag = default(string), string deviceProfileId = default(string), string playSessionId = default(string), string segmentContainer = default(string), int? segmentLength = default(int?), int? minSegments = default(int?), string mediaSourceId = default(string), string deviceId = default(string), string audioCodec = default(string), bool? enableAutoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? breakOnNonKeyFrames = default(bool?), int? audioSampleRate = default(int?), int? maxAudioBitDepth = default(int?), int? audioBitRate = default(int?), int? audioChannels = default(int?), int? maxAudioChannels = default(int?), string profile = default(string), string level = default(string), float? framerate = default(float?), float? maxFramerate = default(float?), bool? copyTimestamps = default(bool?), long? startTimeTicks = default(long?), int? width = default(int?), int? height = default(int?), int? videoBitRate = default(int?), int? subtitleStreamIndex = default(int?), SubtitleDeliveryMethod? subtitleMethod = default(SubtitleDeliveryMethod?), int? maxRefFrames = default(int?), int? maxVideoBitDepth = default(int?), bool? requireAvc = default(bool?), bool? deInterlace = default(bool?), bool? requireNonAnamorphic = default(bool?), int? transcodingMaxAudioChannels = default(int?), int? cpuCoreLimit = default(int?), string liveStreamId = default(string), bool? enableMpegtsM2TsMode = default(bool?), string videoCodec = default(string), string subtitleCodec = default(string), string transcodeReasons = default(string), int? audioStreamIndex = default(int?), int? videoStreamIndex = default(int?), EncodingContext? context = default(EncodingContext?), Dictionary<string, string> streamOptions = default(Dictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling VideosApi->HeadVideoStreamByContainer");
        ...
        /// <param name="ids">Item id list. This allows multiple, comma delimited.</param>
        /// <returns></returns>
        public void MergeVersions (List<Guid> ids)
        {
        ...
        /// <param name="ids">Item id list. This allows multiple, comma delimited.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> MergeVersionsWithHttpInfo (List<Guid> ids)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new ApiException(400, "Missing required parameter 'ids' when calling VideosApi->MergeVersions");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("MergeVersions", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task MergeVersionsAsync (List<Guid> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
             await MergeVersionsWithHttpInfoAsync(ids, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> MergeVersionsWithHttpInfoAsync (List<Guid> ids, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                throw new ApiException(400, "Missing required parameter 'ids' when calling VideosApi->MergeVersions");
