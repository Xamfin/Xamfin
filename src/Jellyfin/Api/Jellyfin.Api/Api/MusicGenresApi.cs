...
namespace Jellyfin.Api.Api
{
    ...
    /// </summary>
    public interface IMusicGenresApi : IApiAccessor
    {
        ...
        BaseItemDto GetMusicGenre (string genreName, Guid? userId = default(Guid?));
        ...
        ApiResponse<BaseItemDto> GetMusicGenreWithHttpInfo (string genreName, Guid? userId = default(Guid?));
        /// <summary>
        ...
        /// <param name="includeItemTypes">Optional. If specified, results will be filtered in based on item type. This allows multiple, comma delimited. (optional)</param>
        ...
        /// <param name="enableTotalRecordCount">Optional. Include total record count. (optional, default to true)</param>
        /// <returns>BaseItemDtoQueryResult</returns>
        BaseItemDtoQueryResult GetMusicGenres (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?));
        ...
        ApiResponse<BaseItemDtoQueryResult> GetMusicGenresWithHttpInfo (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?));
        ...
        System.Threading.Tasks.Task<BaseItemDto> GetMusicGenreAsync (string genreName, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BaseItemDto>> GetMusicGenreWithHttpInfoAsync (string genreName, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all music genres from a given item, folder, or the entire library.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<BaseItemDtoQueryResult>> GetMusicGenresWithHttpInfoAsync (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MusicGenresApi : IMusicGenresApi
    {
        private Jellyfin.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MusicGenresApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MusicGenresApi(String basePath)
        {
        ...
        /// <returns></returns>
        public MusicGenresApi(Jellyfin.Api.Client.Configuration configuration = null)
        {
        ...
        /// <param name="userId">Optional. Filter by user id, and attach user data. (optional)</param>
        /// <returns>BaseItemDto</returns>
        public BaseItemDto GetMusicGenre (string genreName, Guid? userId = default(Guid?))
        {
        ...
        /// <param name="userId">Optional. Filter by user id, and attach user data. (optional)</param>
        /// <returns>ApiResponse of BaseItemDto</returns>
        public ApiResponse<BaseItemDto> GetMusicGenreWithHttpInfo (string genreName, Guid? userId = default(Guid?))
        {
            // verify the required parameter 'genreName' is set
            if (genreName == null)
                throw new ApiException(400, "Missing required parameter 'genreName' when calling MusicGenresApi->GetMusicGenre");

            var localVarPath = "/MusicGenres/{genreName}";
            ...
            if (genreName != null) localVarPathParams.Add("genreName", this.Configuration.ApiClient.ParameterToString(genreName)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("GetMusicGenre", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of BaseItemDto</returns>
        public async System.Threading.Tasks.Task<BaseItemDto> GetMusicGenreAsync (string genreName, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<BaseItemDto> localVarResponse = await GetMusicGenreWithHttpInfoAsync(genreName, userId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (BaseItemDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<BaseItemDto>> GetMusicGenreWithHttpInfoAsync (string genreName, Guid? userId = default(Guid?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'genreName' is set
            if (genreName == null)
                throw new ApiException(400, "Missing required parameter 'genreName' when calling MusicGenresApi->GetMusicGenre");
        ...
        {
             ApiResponse<BaseItemDtoQueryResult> localVarResponse = GetMusicGenresWithHttpInfo(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount);
             return localVarResponse.Data;
        }
        ...
        /// <param name="enableTotalRecordCount">Optional. Include total record count. (optional, default to true)</param>
        /// <returns>ApiResponse of BaseItemDtoQueryResult</returns>
        public ApiResponse<BaseItemDtoQueryResult> GetMusicGenresWithHttpInfo (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?))
        {

            var localVarPath = "/MusicGenres";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetMusicGenres", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of BaseItemDtoQueryResult</returns>
        public async System.Threading.Tasks.Task<BaseItemDtoQueryResult> GetMusicGenresAsync (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<BaseItemDtoQueryResult> localVarResponse = await GetMusicGenresWithHttpInfoAsync(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (BaseItemDtoQueryResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<BaseItemDtoQueryResult>> GetMusicGenresWithHttpInfoAsync (int? startIndex = default(int?), int? limit = default(int?), string searchTerm = default(string), Guid? parentId = default(Guid?), List<ItemFields> fields = default(List<ItemFields>), List<string> excludeItemTypes = default(List<string>), List<string> includeItemTypes = default(List<string>), bool? isFavorite = default(bool?), int? imageTypeLimit = default(int?), List<ImageType> enableImageTypes = default(List<ImageType>), Guid? userId = default(Guid?), string nameStartsWithOrGreater = default(string), string nameStartsWith = default(string), string nameLessThan = default(string), bool? enableImages = default(bool?), bool? enableTotalRecordCount = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
